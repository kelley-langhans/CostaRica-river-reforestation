...
# run with docker on terminal using the following command: docker run --rm -it -v `pwd`:/usr/local/workspace -v "/Users/kelleylanghans/Desktop/Old_comp_transfer/Stanford/Research/Costa Rica/Modeling/NDR/NDR_InVEST_output/22Jan21":/data  therealspring/inspring:latest ndr_n_rastercalc.py
...
def main():
    ...
    rasterpath1 = '/Data/NDR/NDR_InVEST_output/Baseline_22Jan21/n_export_CR_baseline_3.7.0_22Jan21.tif' # pulling from "data" directory we set up on Docker in the above command (since we're pulling data from a different folder than we're running in
    rasterpath2 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scenario_hieffforest_3.7.0_22Jan21.tif'
    rasterpath3 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scenario_medeffforest_3.7.0_22Jan21.tif'
    rasterpath4 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scenario_loeffforest_3.7.0_22Jan21.tif'
    # set up raster to write results to for calculator
    target_raster_path2 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scen10_hieffforest_22Jan21_diff.tif'
    target_raster_path3 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scen10_medeffforest_22Jan21_diff.tif'
    target_raster_path4 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scen10_loeffforest_22Jan21_diff.tif'
    ...
    rasterpath5 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scen10_hieffforest_22Jan21_diff.tif'
    rasterpath6 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scen10_loeffforest_22Jan21_diff.tif'
    # Write path
    target_raster_path5 = '/Data/NDR/NDR_InVEST_output/n_export_CR_scen10_himinloeffforest_22Jan21_diffofdiff.tif'
    # Get raster info
